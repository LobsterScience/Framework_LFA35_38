...
setwd(fd)
io = readRDS('IndicesFromFullComboModelSept26.rds')
ind35 = io[[1]]
ind36 = io[[2]]
ind38 = io[[3]]

ggplot(subset(ind35,year<2024),aes(year,est,ymin=lwr,ymax=upr))+geom_point()+geom_ribbon(alpha=.25)+theme_test()+geom_path()
ggplot(subset(ind35,year>=1995 &year<2024),aes(year,est,ymin=lwr,ymax=upr))+geom_point()+geom_ribbon(alpha=.25)+theme_test()+geom_path()
...
ggplot(subset(ind36,year<2024),aes(year,est,ymin=lwr,ymax=upr))+geom_point()+geom_ribbon(alpha=.25)+theme_test()+geom_path()
ggplot(subset(ind36,year>=1995 &year<2024),aes(year,est,ymin=lwr,ymax=upr))+geom_point()+geom_ribbon(alpha=.25)+theme_test()+geom_path()
...
ggplot(subset(ind38,year<2024),aes(year,est,ymin=lwr,ymax=upr))+geom_point()+geom_ribbon(alpha=.25)+theme_test()+geom_path()
ggplot(subset(ind38,year>=1995 &year<2024),aes(year,est,ymin=lwr,ymax=upr))+geom_point()+geom_ribbon(alpha=.25)+theme_test()+geom_path()
