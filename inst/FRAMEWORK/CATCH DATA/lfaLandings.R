...
subsamp<-g[g$SYEAR >2012 & g$SYEAR <2024,]
range(subsamp$LFA35)
median(subsamp$LFA35)
### Effort Description 10 year
range(subsamp$EFF)*1000
median(subsamp$EFF)*1000
...
ggsave(filename = "land38B.png", plot = land38B, path = "C:/Users/HowseVJ/OneDrive - DFO-MPO/LFA 35-38 Framework Resources/Figures", width = 8, height = 6, units = "in", dpi = 300)
