...
# LFA 35 for  1995 and 2023
L35_95 <- land35$LANDINGS_MT[land35$SYEAR == 1995]
L35_23 <- land35$LANDINGS_MT[land35$SYEAR== 2023]
# percent increase
per_inc35 <- ((L35_23 - L35_95 ) / L35_95 ) * 100

# LFA 36 for  1995 and 2023
L36_95 <- land36$LANDINGS_MT[land36$SYEAR == 1995]
L36_23 <- land36$LANDINGS_MT[land36$SYEAR== 2023]
# percent increase
per_inc36 <- ((L36_23 - L36_95 ) / L36_95 ) * 100

# LFA 38 for  1995 and 2023
L38_95 <- land38$LANDINGS_MT[land38$SYEAR == 1995]
L38_23 <- land38$LANDINGS_MT[land38$SYEAR== 2023]
# percent increase
per_inc38 <- ((L38_23 - L38_95 ) / L38_95 ) * 100
...
histland<-ggplot(merge_df, aes(x = SYEAR, y = LANDINGS_MT, fill = ifelse(SYEAR == 2024, "2024", "Other"))) +
  ...
  scale_x_continuous(breaks = seq(1892, 2024, by = 20), expand = c(0.01, 0)) + 
